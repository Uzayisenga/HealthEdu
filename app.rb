...
class App < Sinatra::Base
  ...
  configure do
    EasyPost.api_key = ENV['EZAK1f5e27ef1f284808976108f3a5f59dc0WUooR1W7eERlW8qBViQppQ']
    set :sendgrid, SendGrid::API.new(api_key: ENV['BbTCgY5kSTmqhwIrQb0BFQ'])
  end
  post '/easypost-webhook' do
    ...
    if parsed_request['object'] == 'Event' && parsed_request['description'] == 'tracker.updated'
      ...
      message = "Hey, this is HealtheduLTD."
      if tracker.status == 'delivered'
        message += "Your courses has arrived! "
      else
        message += "There's an update on your courses: "
      end
      ...
      to = SendGrid::Email.new(email: 'aminauzayisenga@gmail.com')
