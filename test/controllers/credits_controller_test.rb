...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post credits_url, params: { credit: { course_id: @credit.course_id, name: @credit.name, upload_file: @credit.upload_file } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { course_id: @credit.course_id, name: @credit.name, upload_file: @credit.upload_file } }
